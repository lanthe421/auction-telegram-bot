...
💳 **Платежи:**
• Всего платежей: {total_payments}
• Завершенных: {completed_payments}
• В обработке: {pending_payments}

💰 **Выручка:**
• Общая выручка: {total_revenue:,.2f} ₽
• Комиссии: {commission_revenue:,.2f} ₽
• Чистая прибыль: {commission_revenue:,.2f} ₽

📊 **Статистика:**
• Средний платеж: {total_revenue/completed_payments:,.2f} ₽" if completed_payments > 0 else "• Средний платеж: 0 ₽"
        """
